...
import { COLORS, MODELS, MATERIALS, FINISHES } from "@/validator/option-validator";
import {
   DropdownMenu,
   DropdownMenuContent,
   DropdownMenuItem,
                              ...
                              {COLORS.map((color) => (
                                 <Radio
                                    ...
                                    className={({ focus, checked }) =>
                                       cn(
                                          "relative -m-0.5 flex cursor-pointer items-center justify-center rounded-full p-0.5 mx-0.5 active:ring-0 focus:ring-0 active:outline-none focus:outline-none border-2 border-transparent",
                                          {
